...
Mapping Mappings::Mixwave::getThomasPridgenDrumsMapping() {
    using namespace Keys;
    return Mapping("Mixwave Thomas Pridgen Drums", {
        {Cymbal::Hit::China::_1, {{Note::E, 2}, {Note::E, 6}}},
        {Cymbal::Choke::China::_1, {{Note::F, 6}}},
        ...
        {Cymbal::Hit::Stack::_2, {{Note::A_SHARP, 2}}},
        {Cymbal::Hit::Stack::_3, {{Note::G, 3}}},
        ...
        {Hat::Hit::Open::_1, {{Note::A_SHARP, 1}, {Note::F_SHARP, 4}}},
        {Hat::Hit::Open::_2, {{Note::G, 4}}},
        {Hat::Hit::Closed::Foot::_1, {{Note::G_SHARP, 1}, {Note::G_SHARP, 4}}},
        {Hat::Hit::Open::Pedal::Splash::_1, {{Note::G_SHARP, 1}, {Note::G_SHARP, 4}}},
        {Hat::Hit::Closed::Tip::Tight::_1, {{Note::D, 4}}},
        {Hat::Hit::Open::X::_1, {{Note::D, 3}, {Note::D_SHARP, 3}, {Note::E, 3}, {Note::F, 3}}},
