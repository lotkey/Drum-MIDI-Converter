...
Mapping Mappings::Toontrack::getEZDrummerProgressiveFoundryMapping() {
    ...
    return Mapping("Toontrack EZdrummer Progressive Foundry", {
        ...
        {Hat::Hit::Open::Loose::_1, {{Note::E, 3}}},
        {Hat::Hit::Open::_0, {{Note::C, 0}}},
        {Hat::Hit::Open::_1, {{Note::C_SHARP, 0}}},
        {Hat::Hit::Open::_2, {{Note::D, 0}}},
        {Hat::Hit::Open::_3, {{Note::C, 3}}},
        {Hat::Hit::Open::_4, {{Note::F, -1}, {Note::F_SHARP, -1}, {Note::G, -1}}},
