...
Mapping Mappings::GetGoodDrums::Invasion::getGGDMapping() {
    using namespace Keys;
    return Mapping("GGD Invasion - GGD", {
        {Cymbal::Hit::China::_1, {{Note::B, 3}}},
        {Cymbal::Choke::China::_1, {{Note::C, 4}}},
        {Cymbal::Hit::Crash::_1, {{Note::C_SHARP, 3}}},
        {Cymbal::Choke::Crash::_1, {{Note::D, 3}}},
        ...
        {Hat::Hit::Closed::Edge::Tight::_1, {{Note::F_SHARP, 2}}},
