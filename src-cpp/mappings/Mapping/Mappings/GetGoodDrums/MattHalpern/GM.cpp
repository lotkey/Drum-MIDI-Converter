...
Mapping Mappings::GetGoodDrums::MattHalpern::getGMMapping() {
    ...
    return Mapping("GGD Matt Halpern - GM", {
        ...
        {Hat::Hit::Open::Edge::_0, {{Note::A_SHARP, 1}}},
        {Hat::Hit::Open::Tip::_0, {{Note::A_SHARP, 2}}},
