...
Mapping Mappings::GetGoodDrums::OneKitWonder::Metal::getInvasionmapping() {
    using namespace Keys;
    return Mapping("GGD OKW Metal - Invasion (Default)", {
        ...
        {Hat::Hit::Open::Edge::_0, {{Note::G_SHARP, 1}}},
        {Hat::Hit::Open::Tip::_0, {{Note::G, 1}}},
