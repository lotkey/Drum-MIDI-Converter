...
Mapping Mappings::Drumforge::getBergstrandMapping() {
    return Mapping("Drumforge Bergstrand", {
        ...
        {Cymbal::Hit::Ride::ride1_bow_tip, yamahatoi(Note::G, 3)},
        {Cymbal::Hit::Ride::ride1_edge, yamahatoi(Note::G_SHARP, 3)},
        ...
        {Hat::Closed::hat_closed_edge, yamahatoi(Note::G, 2)},
        {Hat::Closed::hat_closed_tip, yamahatoi(Note::G_SHARP, 2)},
        ...
        {Hat::Closed::hat_tight_edge, yamahatoi(Note::A, 2)},
        {Hat::Closed::hat_tight_tip, yamahatoi(Note::A_SHARP, 2)},
