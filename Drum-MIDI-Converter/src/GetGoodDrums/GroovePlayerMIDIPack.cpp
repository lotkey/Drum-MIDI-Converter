...
Mapping Mappings::GetGoodDrums::getGroovePlayerMIDIPackMapping() {
    return Mapping("GGD Groove Player MIDI Pack", {
        ...
        {Cymbal::Hit::Ride::ride1_edge, yamahatoi(Note::B, 2)},
        ...
        {Hat::Closed::hat_closed_edge, yamahatoi(Note::F_SHARP, 2)},
        {Hat::Closed::hat_closed_tip, yamahatoi(Note::A_SHARP, -2)},
        ...
        {Hat::Closed::hat_tight_tip, yamahatoi(Note::D, 3)},
