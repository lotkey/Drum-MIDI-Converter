...
Mapping Mappings::XLNAudio::getAddictiveDrums2Mapping() {
    return Mapping("XLN Audio Addictive Drums 2", {
        {Perc::cowbell, yamahatoi(Note::B, 1)},
        ...
        {Cymbal::Hit::Ride::ride1_bow_tip, yamahatoi(Note::A, 1)},
        {Cymbal::Choke::Ride::ride1_choke, yamahatoi(Note::D_SHARP, 3)},
        {Cymbal::Bell::Ride::ride2_bell, yamahatoi(Note::C_SHARP, 5)},
        {Cymbal::Hit::Ride::ride2_bow, yamahatoi(Note::D, 5)},
        {Cymbal::Hit::Ride::ride2_bow_tip, yamahatoi(Note::C, 5)},
        ...
        {Hat::Closed::hat_closed_bell, yamahatoi(Note::F, 2)},
        {Hat::Closed::hat_closed_edge, yamahatoi(Note::E, 2)},
        {Hat::Closed::hat_closed_tip, yamahatoi(Note::D_SHARP, 2)},
        {Hat::Open::hat_loose, yamahatoi(Note::F_SHARP, 2)},
        {Hat::Open::hat_open0, yamahatoi(Note::G, 2)},
        {Hat::Open::hat_open0_bell, yamahatoi(Note::A_SHARP, 2)},
        ...
        {Hat::Closed::hat_tight_edge, yamahatoi(Note::D, 2)},
        {Hat::Closed::hat_tight_tip, yamahatoi(Note::C_SHARP, 2)},
